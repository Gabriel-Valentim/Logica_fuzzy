    ...
    for ce in ['boa', 'media', 'ruim']:
        for hd in ['madrugada', 'manha', 'tarde', 'noite']:
            for ds in ['semana', 'fim_semana']:
              if vt == 'alto' and ((hd == 'tarde' or hd == 'manha') and ds == 'semana' or (ds == 'fim_semana' and hd == 'noite')):
                #--- duracao_semafaro = curta
              elif vt == 'alto' and hd == 'madrugada' and ds == 'fim_semana':
                #--duracao_semafaro = longa
